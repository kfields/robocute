...
from .robo.designer import Designer
from .robo.player import RoboCute, RoboBoy, RoboCatGirl
from .robo.player import RoboHornGirl, RoboPinkGirl, RoboPrincessGirl
