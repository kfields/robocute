...
class TestFrame(wx.Frame):
    ...
    def __init__(self, parent, id=-1, title="", pos=wx.DefaultPosition,
        ...
        view_menu = wx.Menu()
        view_menu.Append(ID_CreateGame, "Create Game")
        ...
        view_menu.Append(ID_GameContent, "Use a Game for the Content Pane")        
        ...
        self._mgr.AddPane(self.CreateGame(), wx.aui.AuiPaneInfo().Name("game_content").
                          CenterPane().Hide())
        ...
        self._mgr.GetPane("game_content").Show()
        ...
        self.Bind(wx.EVT_MENU, self.OnCreateGame, id=ID_CreateGame)
        ...
        self.Bind(wx.EVT_MENU, self.OnChangeContentPane, id=ID_GameContent)
    ...
    def OnCreateGame(self, event):
        self._mgr.AddPane(self.CreateGame(), wx.aui.AuiPaneInfo().
                          Caption("Game").
                          Float().FloatingPosition(self.GetStartPosition()).
                          CloseButton(True).MaximizeButton(True))
        self._mgr.Update()
    ...
    def OnChangeContentPane(self, event):
        ...
        self._mgr.GetPane("game_content").Show(event.GetId() == ID_GameContent)
        self._mgr.Update()
...
class TestApp(wx.App):
    def OnInit(self):
        self.frame = TestFrame(None, -1, 'Test wxPython + AUI + pyglet')
